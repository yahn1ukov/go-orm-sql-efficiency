...
func (oq *OrderQuery) QueryProducts() *OrderProductQuery {
...
func (oq *OrderQuery) WithProducts(opts ...func(*OrderProductQuery)) *OrderQuery {
	query := (&OrderProductClient{config: oq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (oq *OrderQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Order, error) {
	...
	if query := oq.withProducts; query != nil {
		if err := oq.loadProducts(ctx, query, nodes,
			func(n *Order) { n.Edges.Products = []*OrderProduct{} },
			func(n *Order, e *OrderProduct) { n.Edges.Products = append(n.Edges.Products, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (oq *OrderQuery) loadProducts(ctx context.Context, query *OrderProductQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderProduct)) error {
