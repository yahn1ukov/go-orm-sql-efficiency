...
func (opq *OrderProductQuery) QueryOrder() *OrderQuery {
...
func (opq *OrderProductQuery) QueryProduct() *ProductQuery {
...
func (opq *OrderProductQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (opq *OrderProductQuery) WithOrder(opts ...func(*OrderQuery)) *OrderProductQuery {
	query := (&OrderClient{config: opq.config}).Query()
...
func (opq *OrderProductQuery) WithProduct(opts ...func(*ProductQuery)) *OrderProductQuery {
	query := (&ProductClient{config: opq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//
//	client.OrderProduct.Query().
//		Select(orderproduct.FieldOrderID).
//		Scan(ctx, &v)
...
func (opq *OrderProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrderProduct, error) {
	...
	if query := opq.withOrder; query != nil {
		if err := opq.loadOrder(ctx, query, nodes, nil,
			func(n *OrderProduct, e *Order) { n.Edges.Order = e }); err != nil {
			return nil, err
		}
	}
	if query := opq.withProduct; query != nil {
		if err := opq.loadProduct(ctx, query, nodes, nil,
			func(n *OrderProduct, e *Product) { n.Edges.Product = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (opq *OrderProductQuery) loadOrder(ctx context.Context, query *OrderQuery, nodes []*OrderProduct, init func(*OrderProduct), assign func(*OrderProduct, *Order)) error {
...
func (opq *OrderProductQuery) loadProduct(ctx context.Context, query *ProductQuery, nodes []*OrderProduct, init func(*OrderProduct), assign func(*OrderProduct, *Product)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*OrderProduct)
	for i := range nodes {
...
func (opq *OrderProductQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(orderproduct.Table, orderproduct.Columns, sqlgraph.NewFieldSpec(orderproduct.FieldID, field.TypeInt))
	_spec.From = opq.sql
