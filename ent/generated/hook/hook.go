...
import (
	...
	"github.com/yahn1ukov/go-orm-sql-efficiency/ent/generated"
)
...
type OrderFunc func(context.Context, *generated.OrderMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f OrderFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.OrderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.OrderMutation", m)
}

// The OrderProductFunc type is an adapter to allow the use of ordinary
// function as OrderProduct mutator.
type OrderProductFunc func(context.Context, *generated.OrderProductMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f OrderProductFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.OrderProductMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.OrderProductMutation", m)
}
